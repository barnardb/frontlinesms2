...
<g:javascript>
$(function() {
		var data1 = ${y1data} //[40, 28, 18, 20, 10, 30, 15, 30, 18, 48, 205, 0, 20, 15];
		var data2 = ${y2data} // //[30, 18, 48, 25, 5, 20, 15, 40, 28, 18, 20, 0, 30, 15];
		var xdata = ${xdata} // ["05/05", "06/05", "07/05", "08/05", "09/05", "10/05", "11/05", "12/05", "13/05", "14/05", "15/05", "16/05", "17/05", "18/05"];
